...
import { fetchLogout, fetchUpdateUser } from "../../store/modules/user/user.reducer";
import { selectEmailUser, selectNameUser } from "../../store/modules/user/user.selector";
            ...
            <div className={styles.wrapper}>
                ...
                <NavLink
                    ...
                    className={({ isActive }) => isActive
                        ? cn("text text_type_main-large mt-10", styles.link, styles.active_link)
